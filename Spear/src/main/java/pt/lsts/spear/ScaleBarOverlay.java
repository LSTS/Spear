...
public class ScaleBarOverlay extends Overlay implements GeoConstants {
    ...
    private final Rect longitudeBarRect = new Rect();
    // Defaults
    private int xOffset = 10;
    private int yOffset = 10;
    private int minZoom = 0;
    private UnitsOfMeasure unitsOfMeasure = UnitsOfMeasure.metric;
    private boolean latitudeBar = true;
    private boolean longitudeBar = false;
    ...
    ScaleBarOverlay(final MapView mapView) {
        ...
        if ("motorola".equals(manufacturer) && "DROIDX".equals(android.os.Build.MODEL)) {
            ...
            if (windowManager.getDefaultDisplay().getOrientation() > Surface.ROTATION_0) {
     ...
     */
    void setScaleBarOffset(final int x, final int y) {
        xOffset = x;
        yOffset = y;
    }
    ...
    void setAlignRight(final boolean alignRight) {
        this.centred = false;
    ...
    private void drawLatitudeText(final Canvas canvas, final Projection projection) {
        ...
        // Two waypointsFromPlan, xLen apart, at scale bar screen location
        ...
        // get distance in meters between waypointsFromPlan
    ...
    private void drawLongitudeText(final Canvas canvas, final Projection projection) {
        ...
        // Two waypointsFromPlan, yLen apart, at scale bar screen location
    ...
    private String scaleBarLengthText(final double meters) {
